...
<div>
    <main class="pg-main">
                    ...
                    <form name="searchForm" class = "main-searchbox" action="cafe_list.php" onsubmit="click_search(); return false" method = "POST" >
                                           ...
                                           <div id="drop" style="display:none;">
                                                ...
                                                <div class="taglist-bottom">
                                                    <button type="button" class="gray2 tag-btn" id="1" name="tags" value="좌석 많은">#좌석 많은</button>
                                                    <button type="button" class="gray2 tag-btn" id="2" name="tags" value="조용한" >#조용한</button>
                                                    <button type="button" class="gray2 tag-btn" id="3" name="tags" value="24시간 운영" >#24시간 운영</button>
                                                    <button type="button" class="gray2 tag-btn" id="4" name="tags" value="저렴한" >#저렴한</button>
                                                    <button type="button" class="gray2 tag-btn" id="5" name="tags" value="아늑한" >#아늑한</button>
                                                    <button type="button" class="gray2 tag-btn" id="6" name="tags" value="디저트 종류 다양" >#디저트 종류 다양</button>
                                                    <button type="button" class="gray2 tag-btn" id="7" name="tags" value="남/녀 화장실 분리" >#남/녀 화장실 분리</button>
                                                    <button type="button" class="gray2 tag-btn" id="8" name="tags" value="콘센트 많은" >#콘센트 많은</button>
                                                    <button type="button" class="gray2 tag-btn" id="9" name="tags" value="편한 의자" >#편한 의자</button>
                                                    <button type="button" class="gray2 tag-btn" id="10" name="tags" value="이벤트" >#이벤트</button>
                                                    <button type="button" class="gray2 tag-btn" id="11" name="tags" value="창문 넓은" >#창문 넓은</button>
                                                    <button type="button" class="gray2 tag-btn" id="12" name="tags" value="밝은 인테리어" >#밝은 인테리어</button>
                                                    <button type="button" class="gray2 tag-btn" id="13" name="tags" value="음악소리 작은" >#음악소리 작은</button>
                                                    <button type="button" class="gray2 tag-btn" id="14" name="tags" value="평점 높은" >#평점 높은</button>
                                                    <button type="button" class="gray2 tag-btn" id="15" name="tags" value="테이블 넓은" >#테이블 넓은</button>
                                                    <button type="button" class="gray2 tag-btn" id="16" name="tags" value="소란스러운" >#소란스러운</button>
                                                    <button type="button" class="gray2 tag-btn" id="17" name="tags" value="가격 적당" >#가격 적당</button>
                                                    <button type="button" class="gray2 tag-btn" id="18" name="tags" value="1인석" >#1인석</button>
                                                    <button type="button" class="gray2 tag-btn" id="19" name="tags" value="좌석 갯수 보통" >#좌석 갯수 보통</button>
                                                    <button type="button" class="gray2 tag-btn" id="20" name="tags" value="공간 넓은" >#공간 넓은</button>
                                                    <button type="button" class="gray2 tag-btn" id="21" name="tags" value="주차장 완비" >#주차장 완비</button>
                                                    <button type="button" class="gray2 tag-btn" id="22" name="tags" value="요새 뜨는" >#요새 뜨는</button>
                                                </div>
                                            </div>
                                            <script>
                                                    var tagArr = [];
                                                                                                                                  ...
                                                                                                                                  $(document).ready(function () {
                                                                                                                                     $("button").click(function () {
                                                                                                                                             $(this).toggleClass('orange2');
                                                                                                                                             $(this).toggleClass('gray2');
                                                                                                                                             if (this.className == 'tag-btn orange2') {
                                                                                                                                                 tagArr.push(Number(this.id));

                                                                                                                                                 console.log(tagArr);
                                                                                                                                             } else if (this.className == 'tag-btn gray2') {
        ...
        <div class="bottom-container2">
          ...
          <!-- 검색된 카페 리스트 -->
          <div class="d" style= "top: 130px; ">

                <div id="map" style="width:700px;height:420px;"></div>
